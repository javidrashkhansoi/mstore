...
;// CONCATENATED MODULE: ./src/js/scripts/scripts/nav-old.js
...
const wrapperCatalog = document.querySelector(".header-nav__wrapper--catalog");
const headerContacts = wrapperCatalog?.querySelector(".header-contacts");

if (headerContacts) {
  const move = new Move({
    destinationSelector: ".header-nav__wrapper--main",
    targetSelector: ".header-nav__wrapper--catalog .header-contacts",
    breakpoint: 992,
    index: "last",
  });
}
